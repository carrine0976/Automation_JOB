...
if __name__ == "__main__":
    ...
    #填入玩家帳號
    CREATE_BONUS_PLAYER = ["carrine211", "ggg888", "ggg126"]
    bonusAmount=1000
    bonusPointAmount=0
    count=2
    ...
    for player in CREATE_BONUS_PLAYER:
        for promo in prmotion_id:
            create_bonus(player,bonusAmount=bonusAmount,bonusPointAmount=bonusPointAmount,ticketId=random_ticket,ticketQuantity=ticketQuantity,prmotion_id=promo)
            Customerid,claimid = Search_Customer_bonus(player)
